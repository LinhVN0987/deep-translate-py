...
class ServiceDisabledException(BaseError):
    """
    exception thrown if a translator service is temporarily disabled
    """

    def __init__(
        self,
        service,
        message="This translator service is temporarily disabled in this build.",
    ):
